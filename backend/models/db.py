...
class LandingWaitlistRow(Base):
    ...
    # email and phone_number are both nullable; at least one must be set (enforced by DB CHECK constraint).
    # Google OAuth users have email; Supabase phone OTP users have phone_number.
